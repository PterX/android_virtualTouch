...
private:
    ...
    Vector2 rotatePointx(Vector2 pos, Vector2 wh, bool reverse = false);//根据方向来重构坐标,pos是坐标，wh是宽高 --reverse为真代表要反向计算 //举个例子：假如你要在横屏时触摸200，200，就让reverse == ture,假如你要让原始坐标转为实际触摸的就不用动
